"""
Django settings for logger_proj project.
...
import os
try:
    import logger_proj.config as config
...
SECRET_KEY = '#ro5ra)vuwiq8h*25vs*^oqizex&lq^vry06xgq+s==82px88k'
...
WSGI_APPLICATION = 'logger_proj.wsgi.application'
